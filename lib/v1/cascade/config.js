...
const CONFIG = {
  ...
  capabilities: {
    ...
    'ollama-gemini-3-flash': { provider: 'ollama',   modes: ['speed', 'quality'],  supports_structured: true  },
    'ollama-gemma4-31b':     { provider: 'ollama',   modes: ['speed', 'quality'],  supports_structured: true  },
    'ollama-qwen3-vl-235b':  { provider: 'ollama',   modes: ['speed', 'quality'],  supports_structured: true  },
  },
