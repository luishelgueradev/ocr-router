...
/**
 * Best-effort removal of EVERY registered temp dir, then clear the registry.
 * Called from shutdown.js on SIGTERM. Uses allSettled so one failing rm never
 * blocks the others (and never blocks the job drain that calls it).
 * @returns {Promise<void>}
 */
